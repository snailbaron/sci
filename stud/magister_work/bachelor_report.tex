...
\begin{titlepage}
	\begin{center}
		...
		\vspace{25mm}
		{\Large \upshape{ВЫПУСКНАЯ КВАЛИФИКАЦИОННАЯ РАБОТА БАКАЛАВРА}}\\
		\vspace{10mm}
		Тема:\\
		{\large "<Исследование одного класса стохастических КС-""грамматик с разложимой матрицей первых моментов">}\\
		\vspace{10mm}
	\end{center}
	...
	\begin{flushright}
		...
		\vspace{3mm}
		\textbf{Выполнил:} студент группы 84-03\\
